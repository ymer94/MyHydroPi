        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="col-lg-6 col-xs-12 text-center">
                    <button style="margin-bottom: 20px;" type="button" class="btn btn-md btn-info btn-block"
                            onclick="Shutdown()">Shutdown
                    </button>
                </div>
                <div class="col-lg-6 col-xs-12 text-center">
                    <button style="margin-bottom: 20px;" type="button" class="btn btn-md btn-primary btn-block"
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="col-lg-3 col-sm-6 text-center">
                    <button style="margin-bottom: 20px;" type="button" class="btn btn-md btn-info btn-block"
                            onclick="Delete_MySQL(0)">Delete All
                    </button>
                </div>
                <div class="col-lg-3 col-sm-6 text-center">
                    <button style="margin-bottom: 20px;" type="button" class="btn btn-md btn-primary btn-block"
                            onclick="Delete_MySQL(90)">Over 3 Months
                    </button>
                </div>
                <div class="col-lg-3 col-sm-6 text-center">
                    <button style="margin-bottom: 20px;" type="button" class="btn btn-md btn-info btn-block"
                            onclick="Delete_MySQL(180)">Over 6 Months
                    </button>
                </div>
                <div class="col-lg-3 col-sm-6 text-center">
                    <button type="button" class="btn btn-md btn-primary btn-block" onclick="Delete_MySQL(365)">Over 12
                        Months
                    </button>
                </div>
            </div>
            ...
            <form class="form" method="POST" action="/php/update_settings.php">
                <fieldset>
                    ...
                    <div style="background-color:#033C73" class="col-xs-12 text-center">
                        <button style="margin-bottom:5px; margin-top: 5px;" name="singlebutton" class="btn btn-success"
                                id="singlebutton">Update Settings
                        </button>
                    </div>
